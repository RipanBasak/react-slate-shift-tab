(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('react-dom'), require('@gitbook/slate'), require('immutable')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', 'react-dom', '@gitbook/slate', 'immutable'], factory) :
...
function deserialize(string, options) {
  ...
  var value = slate.Value.fromJS(raw, options);
  return value;
}
...
function deserializeNode(string, options) {
  var raw = decode(string);
  var node = slate.Node.fromJS(raw, options);
  return node;
}
...
function deserialize$1(string) {
  ...
  var ret = toJSON ? json : slate.Value.fromJS(json);
  return ret;
}
...
var Content = function (_React$Component) {
  ...
  function Content(props) {
    ...
    _this.isInEditor = function (target) {
      var mustBeEditable = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
      ...
      return (!mustBeEditable || el.isContentEditable) && (el === element || el.closest('[data-slate-editor]') === element);
    };
  ...
  createClass(Content, [{
    ...
    value: function onEvent(handler, event) {
      ...
      if (handler == 'onBeforeInput' || handler == 'onBlur' || handler == 'onCut' || handler == 'onCompositionEnd' || handler == 'onCompositionStart' || handler == 'onFocus' || handler == 'onInput' || handler == 'onKeyDown' || handler == 'onKeyUp' || handler == 'onPaste' || handler == 'onSelect') {
...
function AfterPlugin() {
  ...
  function onClick(event, change, editor) {
    ...
    var isVoid = node.isVoid || document.hasVoidParent(node.key);
...
function ensureSlateSelection(event, change, editor) {
  var readOnly = editor.props.readOnly;
  var value = change.value;
...
function BeforePlugin() {
  ...
  function onCopy(event, change, editor) {
    ...
    var hasSelection = ensureSlateSelection(event, change, editor);
