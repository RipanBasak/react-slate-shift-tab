...
import { List, Map, Record, Set, OrderedSet, Stack } from 'immutable';
import memoize, { resetMemoization, useMemoization } from 'immutablejs-record-memoize';
import direction from 'direction';
import { reverse } from 'esrever';
import Debug from 'debug';
import isEqual from 'lodash/isEqual';
import mergeWith from 'lodash/mergeWith';
import { CHILD_OBJECT_INVALID, CHILD_REQUIRED, CHILD_TYPE_INVALID, CHILD_UNKNOWN, FIRST_CHILD_OBJECT_INVALID, FIRST_CHILD_TYPE_INVALID, LAST_CHILD_OBJECT_INVALID, LAST_CHILD_TYPE_INVALID, NODE_DATA_INVALID, NODE_IS_VOID_INVALID, NODE_MARK_INVALID, NODE_TEXT_INVALID, PARENT_OBJECT_INVALID, PARENT_TYPE_INVALID } from '@gitbook/slate-schema-violations';
  ...
  createClass(Text, [{
    ...
    value: function addMarks(index, length, set$$1) {
      if (this.text === '' && length === 0 && index === 0) {
        ...
        if (!first) {
          return this.set('leaves', List.of(Leaf.fromJS({ text: '', marks: set$$1 })));
        }
    ...
    value: function fromJS(object) {
      ...
      var _object$leaves = object.leaves,
          leaves = _object$leaves === undefined ? List() : _object$leaves;
