...
var memoize = unwrapExports(dist);
var dist_1 = dist.resetMemoization;
var dist_2 = dist.useMemoization;
...
var Block = function (_Record) {
  ...
  createClass(Block, [{
    ...
    value: function toJSON(options) {
      index.deprecate('slate@0.35.0', 'toJSON methods are deprecated, use toJS instead');
    ...
    value: function fromJSON(object) {
      index.deprecate('slate@0.35.0', 'fromJSON methods are deprecated, use fromJS instead');
...
var index$1 = {
  ...
  resetMemoization: dist_1,
  useMemoization: dist_2
};
...
exports.resetMemoization = dist_1;
exports.useMemoization = dist_2;
